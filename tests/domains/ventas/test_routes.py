...
class TestVentasEndpoints:
    ...
    def test_crear_venta_endpoint(self, client_autenticado: TestClient, db_session: Session):
        """Test: POST /api/v1/ventas"""
        from app.models import Usuario, Mesa, Producto
        
        # Mock de sesión
        # (la sesion la provee el fixture client_autenticado; antes se inyectaba una cookie falsa)
        ...
        response = client_autenticado.post("/api/v1/ventas", json=payload)
    ...
    def test_listar_ventas_endpoint(self, client_autenticado: TestClient):
        """Test: GET /api/v1/ventas"""
        response = client_autenticado.get("/api/v1/ventas")
        
        # Sin autenticación
        assert response.status_code in [200, 401]
    
    def test_obtener_venta_endpoint(self, client_autenticado: TestClient):
        """Test: GET /api/v1/ventas/1"""
        response = client_autenticado.get("/api/v1/ventas/1")
        
        # Sin autenticación puede ser 401, pero si pasa la middleware sería 404
        assert response.status_code in [200, 404, 401]
    
    def test_obtener_estados_catalogo(self, client_autenticado: TestClient):
        """Test: GET /api/v1/ventas/catalogo/estados"""
        response = client_autenticado.get("/api/v1/ventas/catalogo/estados")
    ...
    def test_obtener_tipos_venta_catalogo(self, client_autenticado: TestClient):
        """Test: GET /api/v1/ventas/catalogo/tipos"""
        response = client_autenticado.get("/api/v1/ventas/catalogo/tipos")
    ...
    def test_obtener_metodos_pago_catalogo(self, client_autenticado: TestClient):
        """Test: GET /api/v1/ventas/catalogo/pagos"""
        response = client_autenticado.get("/api/v1/ventas/catalogo/pagos")
    ...
    def test_crear_venta_validacion_schema(self, client_autenticado: TestClient):
    ...
    def test_crear_venta_para_llevar(self, client_autenticado: TestClient, db_session: Session):
